<template>
                <div id="overlay">
                        ...
                        <video class="visible-desktop" id="hero-vid" poster="/static/images/joy.jpg" autoplay loop muted>
                            <source type="video/webm" src="/static/videos/redvelvet.mp4"></source>
                        </video>
...
background:url("/static/images/joy.jpg") no-repeat scroll 0 0 #000;

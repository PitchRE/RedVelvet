...
<div>
  <head>
    ...
    <meta name="twitter:image" content="/images/wendy2.webp">
  </head>
  <div class="bgimg-4">
    <div class="caption">
  ...
  >
    <div data-aos="fade-up-right">
      <h3 style="text-align:center;">Shon Seung-wan</h3>
      <p>Wendy Son (born February 21, 1994 in Seongbuk-dong, Seoul. South Korea), better known as just Wendy, is a Korean singer and dancer. She is the main vocalist, sub dancer and sub rapper of the South-Korean girl group Red Velvet.</p>
    </div>
  </div>
  ...
  <div style="position:relative;">
    ...
    >
      <ul style="align:center" class="profile">
        ...
        <li>
          <b>Birth Name:</b> Son Seungwan (손승완) / Wendy Son
        </li>

        <li>
          <b>Nicknames:</b> Olaf, Wan-ah
        </li>

        <li>
          <b>Birthday:</b> February 21, 1994
        </li>

        <li>
          <b>Birthplace:</b> Seongbuk-dong, Seoul, South Korea.
        </li>
        ...
        <li>
          <b>Position:</b> Main Vocalist
        </li>
      </ul>
      <br>
      <br>
      <wendyFacts></wendyFacts>
    </div>
  </div>
  ...
  <div style="position:relative;">
    ...
    >
      ...
      <br>
      <h4>Red Velvet</h4>
      <br>Wendy was assigned to represent the color blue and chosen to be the main vocalist of Red Velvet, which debuted on August 1, 2014.
    </div>
  </div>
...
import wendySolo from "./wendySolo";
import wendyFacts from "./wendyFacts";
export default {
  components: {
    yeriMusicShowcase,
    wendySolo,
...
.bgimg-2 {
  background-image: url("/images/wendy12.webp");
  min-height: 400px;
}

.bgimg-3 {
  background-image: url("/images/wendy2.webp");
  min-height: 400px;
}
.bgimg-4 {
...
.bgimg-5 {
  background-image: url("/images/wendy3.webp");
  min-height: 400px;
}

.bgimg-6 {
  background-image: url("/images/wendy11.webp");
  min-height: 400px;
}
.bgimg-7 {
  background-image: url("/images/wendy10.webp");
  min-height: 400px;
}
.bgimg-8 {
  background-image: url("/images/wendy7.webp");
  min-height: 400px;
}
.bgimg-9 {
  background-image: url("/images/wendyUWU.webp");
  min-height: 400px;
}
.bgimg-10 {
  background-image: url("/images/wendy8.webp");
  min-height: 400px;
}
.caption {
  position: absolute;
